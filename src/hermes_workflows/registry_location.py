...
class ResolvedRegistryLocationV1:
    ...
    def __init__(
        ...
        normalized_registry_dir = _validate_normalized_absolute_path(normalized_registry_dir, label="registry_dir")
        normalized_registry_path = _validate_normalized_absolute_path(normalized_registry_path, label="registry_path")
        normalized_state_root = _validate_normalized_absolute_path(normalized_state_root, label="state_root_path")
        object.__setattr__(self, "schema_version", schema_version)
